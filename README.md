...
Explanation :
"destination" and "filename" are the properties of multer.diskstorage in which we tell where to store the image and what will be the name of the image file.
